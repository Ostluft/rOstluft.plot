...
```
    ...
    #> # A tibble: 6 × 16
    #>   date                site          CO    Hr    NO   NO2   NOx    O3     p
    #>   <dttm>              <fct>      <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>
    #> 1 2013-01-31 21:00:00 Zch_Stamp… 0.191  67.3 0.675  7.70  4.57  71.0  970.
    #> 2 2013-01-31 21:30:00 Zch_Stamp… 0.195  64.9 0.359  7.72  4.33  69.7  970.
    #> 3 2013-01-31 22:00:00 Zch_Stamp… 0.191  65.1 0.424  6.84  3.92  69.0  970.
    #> 4 2013-01-31 22:30:00 Zch_Stamp… 0.184  67.3 0.353  5.38  3.09  70.5  970.
    #> 5 2013-01-31 23:00:00 Zch_Stamp… 0.186  67.3 0.634  5.87  3.58  70.2  969.
    #> 6 2013-01-31 23:30:00 Zch_Stamp… 0.189  68.7 0.435  6.76  3.88  67.6  969.
...
```
    ...
    #>   date                site          CO    Hr    NO   NO2   NOx    O3     p
    #>   <dttm>              <fct>      <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>
    #> 1 2013-12-31 21:00:00 Zch_Stamp…    NA    NA    NA    NA    NA    NA    NA
    #> 2 2013-12-31 21:30:00 Zch_Stamp…    NA    NA    NA    NA    NA    NA    NA
    #> 3 2013-12-31 22:00:00 Zch_Stamp…    NA    NA    NA    NA    NA    NA    NA
    #> 4 2013-12-31 22:30:00 Zch_Stamp…    NA    NA    NA    NA    NA    NA    NA
    #> 5 2013-12-31 23:00:00 Zch_Stamp…    NA    NA    NA    NA    NA    NA    NA
    #> 6 2013-12-31 23:30:00 Zch_Stamp…    NA    NA    NA    NA    NA    NA    NA
    #> # … with 7 more variables: PM10 <dbl>, RainDur <dbl>, SO2 <dbl>,
    #> #   StrGlo <dbl>, T <dbl>, wd <dbl>, ws <dbl>
...
```
    ...
    #> 1 2013-12-31 21:00:00 Zch_Stampfenbachstra… WVv       min30    m/s      NA
    #> 2 2013-12-31 21:30:00 Zch_Stampfenbachstra… WVv       min30    m/s      NA
    #> 3 2013-12-31 22:00:00 Zch_Stampfenbachstra… WVv       min30    m/s      NA
    #> 4 2013-12-31 22:30:00 Zch_Stampfenbachstra… WVv       min30    m/s      NA
    #> 5 2013-12-31 23:00:00 Zch_Stampfenbachstra… WVv       min30    m/s      NA
    #> 6 2013-12-31 23:30:00 Zch_Stampfenbachstra… WVv       min30    m/s      NA
...
```
    ...
    #> # A tibble: 6 × 17
    #>   date                month  site         CO    Hr    NO   NO2   NOx    O3
    #>   <dttm>              <ord>  <fct>     <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>
    #> 1 2013-12-31 21:00:00 Januar Zch_Stam…    NA    NA    NA    NA    NA    NA
    #> 2 2013-12-31 21:30:00 Januar Zch_Stam…    NA    NA    NA    NA    NA    NA
    #> 3 2013-12-31 22:00:00 Januar Zch_Stam…    NA    NA    NA    NA    NA    NA
    #> 4 2013-12-31 22:30:00 Januar Zch_Stam…    NA    NA    NA    NA    NA    NA
    #> 5 2013-12-31 23:00:00 Januar Zch_Stam…    NA    NA    NA    NA    NA    NA
    #> 6 2013-12-31 23:30:00 Januar Zch_Stam…    NA    NA    NA    NA    NA    NA
    #> # … with 8 more variables: p <dbl>, PM10 <dbl>, RainDur <dbl>, SO2 <dbl>,
    #> #   StrGlo <dbl>, T <dbl>, wd <dbl>, ws <dbl>
...
```
    ...
    #>   date                month site          CO    Hr    NO   NO2   NOx    O3
    #>   <dttm>              <ord> <fct>      <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>
    #> 1 2013-12-31 21:00:00 <NA>  Zch_Stamp…    NA    NA    NA    NA    NA    NA
    #> 2 2013-12-31 21:30:00 <NA>  Zch_Stamp…    NA    NA    NA    NA    NA    NA
    #> 3 2013-12-31 22:00:00 <NA>  Zch_Stamp…    NA    NA    NA    NA    NA    NA
    #> 4 2013-12-31 22:30:00 <NA>  Zch_Stamp…    NA    NA    NA    NA    NA    NA
    #> 5 2013-12-31 23:00:00 <NA>  Zch_Stamp…    NA    NA    NA    NA    NA    NA
    #> 6 2013-12-31 23:30:00 <NA>  Zch_Stamp…    NA    NA    NA    NA    NA    NA
    #> # … with 8 more variables: p <dbl>, PM10 <dbl>, RainDur <dbl>, SO2 <dbl>,
    #> #   StrGlo <dbl>, T <dbl>, wd <dbl>, ws <dbl>
